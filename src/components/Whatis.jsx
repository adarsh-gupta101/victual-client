...
function Whatis() {
  ...
  return (
    <div className='p-8 md:px-28'>
      <p className='text-[#d93A4a]  font-bold text-4xl text-center md:text-left'>What is Shef</p>
      <p className='my-8 text-xl text-gray-500 text-center md:text-left'>
        Shef connects talented cooks with local customers.
      </p>
      <p className='text-xl md:w-2/3 text-gray-500 text-center md:text-left'>
        ...
        affordable price.{" "}
        <span className='text-xl font-bold block mt-3 md:mt-0 md:inline'>
      ...
      <p className='text-[#d93A4a]  font-bold text-4xl mt-24 text-center md:text-left'>Why become a shef?</p>
      ...
      {data.map((res) => {
        return (
          <div className="md:w-1/3 p-4 flex flex-col justify-center items-center">
            ...
            <p className="text-2xl font-bold mt-8">{res.title}</p>
