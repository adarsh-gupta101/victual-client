        ...
        <div className="absolute top-10 md:top-40 w-11/12 md:w-4/5 bg ">
          ...
          <div className="md:flex m-8 items-center">
            <input
              ...
              className="py-1 md:ml-28 mr-6 md:px-6 my-2 h-12 w-full md:w-2/4 rounded outline-none"
            />
          </div>
          <p className="text-xl text-white p-2 px-6 rounded-3xl mx-8 md:mx-36 my-6 bg-[#d93A4a] w-fit">
            Get Started
          </p>
        </div>
      </div>
