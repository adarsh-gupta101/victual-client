  ...
  return (
    <div style={{ overflow: "hidden" }} className="bg-[white] pb-16">
      ...
      <Slider {...settings} className="">
        <div className="max-w-3xl p-4 text-gray-800 bg-white rounded-lg shadow">
          <div className="mb-2">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">Cool guy</p>
            </div>
          </div>
        </div>
        <div className="max-w-3xl p-4 text-gray-800 bg-white rounded-lg shadow">
          <div className="mb-2">
            ...
            <div className="h-3 text-3xl text-right text-indigo-600">”</div>
            <div className="text-center">
              <h5 className="font-bold text-indigo-600">Jane Doe</h5>
              <p className="text-sm text-gray-600">Faithful customer</p>
            </div>
          </div>
        </div>
        <div className="max-w-3xl p-4 text-gray-800 bg-white rounded-lg shadow">
          <div className="mb-2">
            ...
            <div className="h-3 text-3xl text-right text-indigo-600">”</div>
            <div className="text-center">
              <h5 className="font-bold text-indigo-600">Jane John</h5>
              <p className="text-sm text-gray-600">A person</p>
            </div>
          </div>
        </div>
      </Slider>
